...
it('tests if session has key', function (): void {
...
it('tests if session has key in flashbag', function (): void {
    $session = new Scrawler\Http\Session();
...
it('tests __set()', function (): void {
    $session = new Scrawler\Http\Session();
    $session->test = 'test';
    expect($session->get('test'))->toBe('test');
});

it('tests stop()', function (): void {
    $session = new Scrawler\Http\Session();
    $session->set('test', 'test');
    $session->stop();
